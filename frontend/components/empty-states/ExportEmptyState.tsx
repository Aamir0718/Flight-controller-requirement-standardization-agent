...
import { UploadCloud, History, FileSpreadsheet, BarChart3, Shield } from "lucide-react";
    ...
    >
      ...
      >
        ...
        <div className="relative p-8 rounded-3xl bg-[#0F172A] border border-[#243244]">
          ...
          >
            <FileSpreadsheet className="w-20 h-20 text-[#1EA7FF]" />
          </motion.div>
        </div>
      </motion.div>
      ...
      >
        ...
        <p className="text-[#8FA3BF] text-sm">
          Complete a requirement review to generate downloadable reports.
        </p>
      </motion.div>
      ...
      >
        <div className="drdo-card p-5 space-y-3 hover:border-[#1EA7FF]/40 transition">
          <div className="flex items-center gap-2 text-[#1EA7FF] mb-2">
            ...
            <span className="text-xs font-bold uppercase tracking-wider">Excel Export</span>
          </div>
          <p className="text-xs text-[#8FA3BF] leading-relaxed">
            Download reviewed workbooks.
          </p>
        </div>
        ...
        <div className="drdo-card p-5 space-y-3 hover:border-[#1EA7FF]/40 transition">
          <div className="flex items-center gap-2 text-[#00C853] mb-2">
            ...
            <span className="text-xs font-bold uppercase tracking-wider">Review Summary</span>
          </div>
          <p className="text-xs text-[#8FA3BF] leading-relaxed">
            Export AI decisions and quality scores.
          </p>
        </div>
        ...
        <div className="drdo-card p-5 space-y-3 hover:border-[#1EA7FF]/40 transition">
          <div className="flex items-center gap-2 text-[#FFB300] mb-2">
            ...
            <span className="text-xs font-bold uppercase tracking-wider">Offline Storage</span>
          </div>
          <p className="text-xs text-[#8FA3BF] leading-relaxed">
            Reports are generated locally and never leave the machine.
          </p>
        </div>
      </motion.div>
    </motion.div>
